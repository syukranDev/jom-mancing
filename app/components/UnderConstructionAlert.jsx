...
const UnderConstructionAlert = () => {
  ...
  return (
    <div ref={targetElement}  className="flex p-4 mb-4 text-red-800 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400" role="alert">
                ...
                {/* ================ */}
                <div id="modalFeatures" data-modal-placement="top-left" tabindex="-1" class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
                        ...
                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                            ...
                            <div class="p-6 space-y-6">
                                ...
                                <ul class="list-disc text-base leading-relaxed pl-10">
                                  ...
                                  <li>Allow visitor to add on 'kolam memancing' data</li>
                                </ul>
                            </div>
                            {/* <!-- Modal footer --> */}
